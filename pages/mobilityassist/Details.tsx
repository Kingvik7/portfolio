...
const project = {
    ...
    highlights: ["Presented at IEEE conference held in Brisbane, Australia", "Published in IEEE Xplore"],
    tag1: "swift",
    tag2: "ARKit",
    tag3: "LiDAR",
}
            ...
            <div className="pt-8">
                ...
                <div className="mx-auto max-w-2xl  pt-2 pb-16  lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8  lg:pt-2 lg:pb-8">
                    ...
                    <div className="mt-0 lg:row-span-3 lg:mt-0">
                        ...
                        <form className="">
                            <a href="https://ieeexplore.ieee.org/document/9744605" target='_blank' rel="noreferrer" className="mt-2 flex w-full items-center justify-center rounded-md border border-transparent bg-pink-600 py-3 px-8 text-center font-medium text-white hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                                View on IEEE
                            </a>
                        </form>
                    </div>
